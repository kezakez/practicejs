...
(function () {
    ...
    function rollingMaximum(inputArray, windowSize) {
        if (!(inputArray instanceof Array)) {
            throw "inputArray should be an array";
        }
        if (windowSize > inputArray.length || windowSize < 1 || !windowSize) {
            throw "windowSize should be less than inputArray length and greater than 1";
        }
